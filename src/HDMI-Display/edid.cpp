...
// for 480x272 display
uint8_t PROGMEM eepromdata_480x272[128] =
{
...
uint8_t PROGMEM eepromdata_720x480[128] =
{
  0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x5C,0x34,0x01,0x00,0x01,0x00,0x00,0x00,
...
// for 800x480 display
uint8_t PROGMEM eepromdata_800x480[128] =
{
  0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x5C,0x34,0x01,0x00,0x01,0x00,0x00,0x00,
  0x01,0x19,0x01,0x03,0x80,0x00,0x00,0x00,0x0A,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,
...
bool EDID::writeEDID(uint8_t type)
{
  ...
  {
    case EDID_480x272:
      return writeData(eepromdata_480x272, sizeof(eepromdata_480x272), true);
    
    case EDID_720x480:
      return writeData(eepromdata_720x480, sizeof(eepromdata_720x480), true);

    case EDID_800x480:
      return writeData(eepromdata_800x480, sizeof(eepromdata_800x480), true);
