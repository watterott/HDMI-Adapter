...
Further infos can also be found in the [schematics](https://github.com/watterott/HDMI-Display/tree/master/hardware).
...
*** TFT needs hardware modification for HDMI-Adapter v1.0, see [schematics](https://github.com/watterott/HDMI-Display/tree/master/hardware)
